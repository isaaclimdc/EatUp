...
DATABASES = {
    'default': {
        ...
        'NAME': 'eatup.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'iv)t1@tis@s%1k989!c^6ej0dm7^183c&amp;$ebhmk+^@dacpod_%'
...
ROOT_URLCONF = 'eatupBackendProj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'eatupBackendProj.wsgi.application'
...
AUTH_PROFILE_MODULE = 'eatupBackendApp.UserProfile'
